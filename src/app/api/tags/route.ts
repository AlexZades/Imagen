...
export async function POST(request: NextRequest) {
  try {
    const { name, loras, minStrength, maxStrength, forcedPromptTags, description, slider, sliderLowText, sliderHighText, nsfw, maleCharacterTags, femaleCharacterTags, otherCharacterTags } = await request.json();
